...
export const OP_RESULT_CODES = {
  ...
  NETWORK_ERROR: -12000,
  TIMEOUT: -13000,
  NOT_IMPLEMETED: -14000,
  NOT_IMPLEMENTED: -14000,
  VALIDATION_FAILED: -20100,
  NOT_FOUND: -20200,
  CONFLICT: -20300,
  LIMIT_REACHED: -20400,
  TOO_MANY_REQUESTS: -21000,
  UNAUTHORIZED: -30100,
  FORBIDDEN: -30200,
  EXPIRED: -30300,
...
export type OpResultCode = (typeof OP_RESULT_CODES)[keyof typeof OP_RESULT_CODES];

export const OP_RESULT_CODE_TO_HTTP_CODE: Record<OpResultCode, number> = {
  ...
  [OP_RESULT_CODES.NOT_IMPLEMENTED]: HTTP_STATUSES.HS_501_NOT_IMPLEMENTED,
  ...
  [OP_RESULT_CODES.TOO_MANY_REQUESTS]: HTTP_STATUSES.HS_429_TOO_MANY_REQUESTS,
